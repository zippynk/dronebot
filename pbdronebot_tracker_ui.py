...
class Ui_pbdronebotTrackerWindow(object):
    def setupUi(self, pbdronebotTrackerWindow, server="localhost"):
        ...
        self.latstat.setGeometry(QtCore.QRect(10, 570, 101, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.lonstat.setGeometry(QtCore.QRect(10, 590, 101, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.locstat.setGeometry(QtCore.QRect(10, 610, 101, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.lat.setGeometry(QtCore.QRect(130, 570, 101, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.lon.setGeometry(QtCore.QRect(130, 590, 101, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.loc.setGeometry(QtCore.QRect(130, 610, 900, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
